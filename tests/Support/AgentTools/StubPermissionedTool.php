 ...
 */
class StubPermissionedTool implements AgentToolInterface
{
    public function name(): string { return 'stub_permissioned'; }
    public function description(): string { return 'A stub requiring user-read.'; }
    public function parameters(): array { return ['type' => 'object', 'properties' => []]; }
    public function permission(): ?string { return 'user-read'; }
    ...
    {
        return AgentToolResult::scalar(['ok' => true]);
    }
}
