 ...
 */
class StubManyRowsTool implements AgentToolInterface
{
    public function name(): string { return 'stub_many_rows'; }
    public function description(): string { return 'A stub returning more rows than the cap.'; }
    ...
    public function execute(array $arguments, AgentToolContext $context): AgentToolResult
    {
        ...
        for ($i = 0; $i < $context->maxRows + 10; $i++) {
            $rows[] = ['id' => $i];
        }
