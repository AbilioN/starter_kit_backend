...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Only for messages that carry product meaning a validation rule cannot
    | express. Anything that merely restates its rule belongs to the defaults
    | above — that is what those are for, and they are already translated.
    |
    */

    'custom' => [
        'plan_id' => [
            // The plan may exist and still not be one a stranger may sign up to.
            'not_public' => 'Le plan sélectionné n\'est pas disponible à l\'inscription en libre-service.',
        ],
    ],
];
