...
7. See root `roadmap.md` → Sprint 0 addenda for the next batch of multitenancy/monetization improvements. **Tenant-suspension notifications (0.7) are now fully done** as of 2026-08-07, backend and Nuxt — see `roadmap.md` → 0.7 for detail. Still not started: GodAdmin 2FA (0.8), GodAdmin changing an existing tenant's plan (0.9), white-label tenant emails (0.10).
