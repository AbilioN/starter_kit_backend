                        ...
                        <div class="flex items-center gap-8">
                            ...
                            <div class="hidden sm:flex sm:gap-1">
                                ...
                                <a href="{{ url('/god/infrastructure-providers') }}"
                                   class="rounded-md px-3 py-2 text-sm font-medium text-slate-300 hover:bg-slate-800 hover:text-white transition">Infrastructure</a>
                                <a href="{{ url('/god/agent-profiles') }}"
                                   class="rounded-md px-3 py-2 text-sm font-medium text-slate-300 hover:bg-slate-800 hover:text-white transition">Agent Profiles</a>
                                <a href="{{ url('/god/backups') }}"
                                   class="rounded-md px-3 py-2 text-sm font-medium text-slate-300 hover:bg-slate-800 hover:text-white transition">Backups</a>
                                <a href="{{ url('/god/security') }}"
                                   class="rounded-md px-3 py-2 text-sm font-medium text-slate-300 hover:bg-slate-800 hover:text-white transition">Security</a>
                            </div>
                        </div>
